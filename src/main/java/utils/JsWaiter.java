...
public class JsWaiter extends JsManager {

    private int timeoutInSeconds;

    public JsWaiter(int timeout) {
        this.timeoutInSeconds = timeout;
    }

    private WebDriverWait jsWait() {
        return new WebDriverWait(jsWaitDriver(), timeoutInSeconds);
    }
    ...
    public void waitAllActionsToBeCompleted() {
        waitUntilJSReady();
        ajaxComplete();
